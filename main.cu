...
int main(int argc, char** argv) {
    ...
    std::cout << "  Available VRAM: " << std::setprecision(1) << (float)(props.totalGlobalMem) / (1 << 30) << " GB\n";
    std::cout << "  Shared mem. per block: " << std::setprecision(1) << (float)(props.sharedMemPerBlock) / (1 << 10) << " KB\n";
