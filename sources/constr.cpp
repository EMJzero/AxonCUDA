...
namespace constraints {
    ...
    bool Constraints::checkFit(const hgraph::HyperGraph& hg, bool already_partitioned, bool verbose) const {
    ...
    HedgeOverlapMetrics Constraints::hedgeOverlap(const hgraph::HyperGraph& hg, const std::vector<uint32_t>& partitions) const {
        if (partitions.empty())
            return {};
    ...
    Constraints Constraints::createLoihiLarge() {
    ...
    Constraints Constraints::createLoihiJin84() {
    ...
    Constraints Constraints::createLoihiJin1024() {
    ...
    Constraints Constraints::createTrueNorth() {
